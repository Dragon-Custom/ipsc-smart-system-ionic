...
export type Score = Node & {
  ...
  scorelist?: Maybe<Scorelist>;
  scorelistId?: Maybe<Scalars['Int']['output']>;
  shooter?: Maybe<Shooter>;
  shooterId?: Maybe<Scalars['Int']['output']>;
  state: ScoreState;
...
export type Scorelist = Node & {
  ...
  scoreboard?: Maybe<Scoreboard>;
  scoreboardId?: Maybe<Scalars['Int']['output']>;
  scores?: Maybe<Array<Maybe<Score>>>;
  stage?: Maybe<Stage>;
...
export type Stage = Node & {
  ...
  designer?: Maybe<Shooter>;
  designerId?: Maybe<Scalars['Int']['output']>;
